...
// Bad because we re implement the full class and its behavior
// and if we want a different behavior for some tests we must
// make another class and implement it.
